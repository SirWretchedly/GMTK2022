...
public class RollingController : MonoBehaviour
{
    ...
    void Update()
    {
        target = GetComponentInParent<PlayerController2>().target;
        if(target == transform.position)
        {
            if (!Input.GetKey("w") && Input.GetKey("s") && !Input.GetKey("d") && !Input.GetKey("a") && !detectBlocks[2].isBlocked)
            {
                turnRightDown(2);
            ...
            if (Input.GetKey("w") && !Input.GetKey("s") && !Input.GetKey("d") && !Input.GetKey("a") && !detectBlocks[0].isBlocked)
            {
                turnLeftUp(2);
                up.currentItem = stiva2[0];
                down.currentItem = stiva2[1];
            ...
            if (!Input.GetKey("w") && !Input.GetKey("s") && Input.GetKey("d") && !Input.GetKey("a") && !detectBlocks[1].isBlocked)
            {
                turnRightDown(1);
                up.currentItem = stiva2[0];
                down.currentItem = stiva2[1];
            ...
            if (!Input.GetKey("w") && !Input.GetKey("s") && !Input.GetKey("d") && Input.GetKey("a") && !detectBlocks[3].isBlocked)
            {
                turnLeftUp(1);
                up.currentItem = stiva2[0];
                down.currentItem = stiva2[1];
